 ...
 * You need to invoke {@link org.apache.lucene.wordnet.Syns2Index} first to build the synonym index.
 *
 * @see org.apache.lucene.wordnet.Syns2Index
 */
public final class SynExpandExt {
     ...
     *
     * <code><pre>
     * Query: big adult^0.9 bad^0.9 bighearted^0.9 boastful^0.9 boastfully^0.9 bounteous^0.9 bountiful^0.9 braggy^0.9
     ...
     * dog andiron^0.9 blackguard^0.9 bounder^0.9 cad^0.9 chase^0.9 click^0.9 detent^0.9 dogtooth^0.9 firedog^0.9
    ...
    public static void main(String[] args) throws IOException {
        ...
        Query q = expand(query, searcher, new StandardAnalyzer(Version.LUCENE_CURRENT), field, 1.2f,0.9f);
     ...
     * {@link org.apache.lucene.wordnet.Syns2Index}. The searcher is not closed or otherwise altered.
     *
