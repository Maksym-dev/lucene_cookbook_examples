        ...
        for (ScoreDoc scoreDoc : topDocs.scoreDocs) {
            ...
            switch (i) {
                case 0:
                    ...
                    break;
                case 1:
                    assertEquals("Score incorrect for position 1", 1.432535171508789d, scoreDoc.score, 0.01d);
                    assertEquals("Wrong document on position 0", "Humpty Dumpty had a great fall.", doc.getField("content").stringValue());
                    break;
                case 2:
                    assertEquals("Score incorrect for position 2", 0.6400539875030518d, scoreDoc.score, 0.01d);
