...
/**
 * Convert the prolog file wn_s.pl from the
 * <a href="http://www.cogsci.princeton.edu/2.0/WNprolog-2.0.tar.gz">WordNet prolog download</a>
 * into a Lucene index suitable for looking up synonyms and performing query expansion ({@link SynExpandExt#expand
 * SynExpandExt.expand(...)}).
 *
 ...
 * That's not a problem with Lucene, you just use {@link Document#getValues}
 * </p>
 * <p>
...
public class Syns2IndexExt {
    ...
    public static void main(String[] args)
        ...
        final Map<String, List<String>> word2Nums = new TreeMap<>();
        // maps a group to all the words in it
        final Map<String, List<String>> num2Words = new TreeMap<>();
...
//            writer.optimize();
    ...
    private static int index(Map<String, List<String>> word2Nums, Map<String, List<String>> num2Words, String g,
        ...
        while (it.hasNext()) {
            ...
            num++;
            doc.add(new StringField(F_SYN, cur, Field.Store.YES));
        }
        return num;
    }
    ...
    private static void usage() {
        o.println("\n\n" +
            "java org.apache.lucene.wordnet.Syns2IndexExt <prolog file> <index dir>\n\n");
    }
